...
const auth_2 = require("@angular/fire/auth");
let SignupComponent = (() => {
    ...
    var SignupComponent = _classThis = class {
        constructor() {
            this.message = '';
            this.auth = null;
            this.fb = (0, core_1.inject)(forms_1.FormBuilder);
        ...
        signup() {
            ...
            (0, auth_1.createUserWithEmailAndPassword)(this.auth, email, password)
                .then((userCredential) => {
                const user = userCredential.user;
                return (0, auth_2.sendEmailVerification)(user); // Sends email verification
            })
                .then(() => {
