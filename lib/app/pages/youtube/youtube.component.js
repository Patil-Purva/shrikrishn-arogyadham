...
let YoutubeComponent = (() => {
    ...
    let _classThis;
    var YoutubeComponent = _classThis = class {
        constructor(http, sanitizer) {
            this.http = http;
            this.sanitizer = sanitizer;
            this.channelId = 'UCR2AZ3n2nR2nriCJBvW3y3A';
            this.apiKey = 'AIzaSyC_b-NYno5dJYi3fHaiHeq9j2pdmxYlGMc';
            this.videos = [];
            this.isLoading = true;
            this.error = null;
        }
        ...
        fetchVideos() {
            ...
            this.http.get(url).subscribe({
                next: (res) => {
                    this.videos = res.items.map((video) => ({
                        ...video,
    ...
    __setFunctionName(_classThis, "YoutubeComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        YoutubeComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return YoutubeComponent = _classThis;
})();
