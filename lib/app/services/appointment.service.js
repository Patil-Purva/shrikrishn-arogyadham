...
let AppointmentService = (() => {
    ...
    var AppointmentService = _classThis = class {
        ...
        async bookAppointment(appointment) {
            const colRef = (0, firestore_1.collection)(this.firestore, 'appointments');
            return await (0, firestore_1.addDoc)(colRef, {
                ...appointment,
                createdAt: new Date()
            });
        }
        ...
        async isSlotBooked(date, time) {
            const colRef = (0, firestore_1.collection)(this.firestore, 'appointments');
            const q = (0, firestore_1.query)(colRef, (0, firestore_1.where)('date', '==', date), (0, firestore_1.where)('time', '==', time));
        ...
        getAppointments() {
            const colRef = (0, firestore_1.collection)(this.firestore, 'appointments');
            return (0, firestore_1.collectionData)(colRef, { idField: 'id' });
        }
    };
